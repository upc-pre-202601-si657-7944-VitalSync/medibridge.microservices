...
public class CreatePatientProfileCommandFromResourceAssembler {
    ...
    public static CreateAssignedPatientProfileCommand toAssignedCommandFromResource(
            CreatePatientProfileResource resource,
            Long requestedByUserId) {
        return new CreateAssignedPatientProfileCommand(resource.fullName(), requestedByUserId);
    }
}
