...
import pe.edu.upc.medibridge.healthmonitoring.infrastructure.messaging.events.PatientRegisteredIntegrationEvent;
...
public class PatientRegisteredEventHandler {
    ...
    public void on(PatientRegisteredIntegrationEvent event) {
        ...
        LOGGER.info("Patient reference received by health monitoring: patientId={}, fullName={}",
