package pe.edu.upc.medibridge.healthmonitoring.infrastructure.messaging;
...
public class RabbitMQConfiguration {
    ...
    public static final String QUEUE_PATIENT_REGISTERED = "healthmonitoring.patient-registered";
    public static final String QUEUE_PATIENT_DEACTIVATED = "healthmonitoring.patient-deactivated";
    public static final String QUEUE_DOCTOR_ASSIGNED_PATIENT = "healthmonitoring.doctor-assigned-patient";
